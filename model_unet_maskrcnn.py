...
def debug_rois(rois):
    tf.print("Number of ROIs:", tf.shape(rois)[0])  # Gibt die Anzahl der ROIs aus
    tf.print("ROIs:", rois)  # Gibt die ROIs selbst aus
...
class MaskRCNN(object):
    ...
    def build(self, mode, config):
        ...
        P4 = KL.Add(name="fpn_p4add")([
            KL.Lambda(lambda x: tf.image.resize(x, size=tf.shape(C4)[1:3]), name="fpn_p5_resized")(P5),
